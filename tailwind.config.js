  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        ring: "var(--color-ring)", // deep-sage-green
        background: "var(--color-background)", // white
        foreground: "var(--color-foreground)", // near-black
        primary: {
          DEFAULT: "var(--color-primary)", // deep-sage-green
          foreground: "var(--color-primary-foreground)", // white
        },
        secondary: {
          DEFAULT: "var(--color-secondary)", // terracotta-brown
        ...
        accent: {
          DEFAULT: "var(--color-accent)", // sandy-brown
